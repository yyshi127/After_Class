...
- [x] M4-06 老师确认/修改/忽略圈错区域  
  ...
  **提交记录：** 已提交到本地 Git：`fa1284b feat(homework): complete M4-06 mistake area confirmation`；GitHub push 待执行。
...
- [ ] M7-01 创建 AiActionLog 模型  
  **内容：** 用户、角色、原始输入、意图、实体、置信度、风险、确认、结果、失败原因。  
  **测试：** 每次 AI 调用都记录日志。

- [ ] M7-02 创建 AiProvider 接口  
